...
$id = $_GET['id'];
$qr = mysql_query("SELECT brand,price,qty,order_item.uuid FROM PRODUCT,order_item WHERE orderid = '$id' and PRODUCT.uuid = order_item.uuid");
?>
                              ...
                              <tbody>
                                <?php while ($brang = mysql_fetch_array($qr)){ ?>
                                  <tr>
                                      ...
                                      <td><?php echo $brang['qty'] ?></td>
                                      <td>RM<?php echo number_format(($brang['price'] * $brang['qty']), 2)  ?></td>
                                  </tr>
                                  <?php } ?>
